...
NOTE: saskatoon-juniper rust, keep at least 2 km away from native juniper trees to avoid

Based on the initial chracteristics outlined, the following datasets are required: 
